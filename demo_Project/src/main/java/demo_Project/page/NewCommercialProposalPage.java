...
import demo_Project.model.NewCommercialProposalModel;
import util.SelectItem;

public class NewCommercialProposalPage extends NewCommercialProposalModel{

	public NewCommercialProposalPage(WebDriver d) {
		super(d);
	}
	
	public String getNewCommercialProposalText() {
		WebElement e = getNewCommercialProposalInfo();
	...
	public void enterValidatyDuration(String date) {
		WebElement e = getValidatyBoxInfo();
		e.clear();
		e.sendKeys(date);
	}
	...
	public void selectSource(String source) {
		WebElement e1 = getSourceInfo();
		SelectItem.selectItem(e1, source);
	}
